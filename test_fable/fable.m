function [UA, OA, alpha, info] = fable( A, compr_type, compr_val, logging, circuit_sim )
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  if isreal(A)
    ...
    % Matrix oracle
    [OA, info_OA] = comprUniformRotation( a, n, N, 'RY', logging, circuit_sim ) ;
    ...
    [circ_mag, info_mag] = comprUniformRotation( a_m, n, N, 'RY', logging, circuit_sim ) ;
    [circ_ph, info_ph] = comprUniformRotation( a_p, n, N, 'RZ', logging, circuit_sim ) ;
...
function [C, info] = comprUniformRotation( vec, n, N, type, logging, circuit_sim )
